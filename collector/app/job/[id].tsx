...
import { fetchJobs, updateJob, type Job } from "../../lib/api";
...
export default function JobDetailScreen() {
  ...
  async function startTrip() {
    ...
    setSaving(true);
    try {
      const updated = await updateJob(job.id, token, "start_trip");
      setJob(updated);
  ...
  async function markCollected() {
    ...
    setSaving(true);
    try {
      const updated = await updateJob(job.id, token, "mark_collected", litersNum);
      setJob(updated);
  ...
  return (
    <ScrollView contentContainerStyle={styles.scroll}>
      <View style={styles.card}>
        ...
        <Text style={styles.label}>Oil type & quantity</Text>
